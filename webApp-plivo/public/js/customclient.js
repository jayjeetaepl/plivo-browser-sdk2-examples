...
navigator.mediaDevices.getUserMedia({ audio: true })
	.then((stream) => {
		...
		// Application can proceed with audio stream
	})
	.catch((error) => {
		console.error("Microphone access denied:", error);
		alert("Audio permission is required. Please allow access from your browser settings.");
	});
...
$('#makecall').click(function (e) {
	...
	extraHeaders["X-PH-header1"] = deviceId
	extraHeaders['X-PH-header2'] = uid
